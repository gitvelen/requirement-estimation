...
> 触发条件见 `ai_workflow.md` 的"质量债务管理规则"章节。
...
**质量债务管理规则**：
- Testing/Deployment 阶段发现的质量问题必须登记债务（见 ai_workflow.md）
- 高风险债务数量 ≥ 5 时，pre-commit 阻断新版本启动
- 质量债务总数 > 10 时，pre-commit 阻断新版本启动
- 每个新版本必须偿还至少 50% 的高风险债务
